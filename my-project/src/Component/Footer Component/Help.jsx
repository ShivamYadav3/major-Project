      ...
      <div className=" flex flex-col gap-y-10 font-bold text-4xl">
        ...
        <div>
          ...
          <p className="text-sm">
            ...
            more. Save time by finding quick solutions without contacting
            customer support.
          </p>
        </div>
        <div>
          ...
          <p className="text-sm">
            Learn how to create an account, update your personal information,
            and manage your preferences. If you encounter any issues with your
        ...
        <div>
          ...
          <p className="text-sm">
            Discover how to book a service and navigate through our
            user-friendly booking process. This section will walk you through
            the steps to schedule services according to your preferences.
          </p>
        </div>
        <div>
